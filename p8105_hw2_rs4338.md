...
```
    ...
    ##    series episode baker   signature_bake           show_stopper technical result
    ##     <dbl>   <dbl> <chr>   <chr>                    <chr>            <dbl> <chr> 
    ##  1      5       1 Nancy   Coffee and Hazelnut Swi… "Jaffa Oran…         1 STAR …
    ##  2      5       2 Richard Rosemary Seeded Crackers "Pirates!"           1 STAR …
    ##  3      5       3 Luis    Opposites Attract Rolls  "Roscón de …         2 STAR …
    ##  4      5       4 Richard Black Forest Chocolate … "Tiramisu B…         5 STAR …
    ##  5      5       5 Kate    Rhubarb and Custard Tart "Rhubarb, P…         3 STAR …
    ##  6      5       6 Chetna  Orange Savarin with Cin… "Almond Liq…         2 STAR …
    ##  7      5       7 Richard Minted Lamb Pasties      "Stair of É…         1 STAR …
    ##  8      5       8 Richard Fruit Swedish Tea Ring   "Rhubarb an…         4 STAR …
    ##  9      5       9 Richard Rose and Pistachio Bakl… "Hazelnut M…         2 STAR …
    ## 10      5      10 Nancy   Apple and Lemon KitesRa… "Red Windmi…         1 WINNER
    ## # ℹ 50 more rows
    ## # ℹ 4 more variables: baker_last_name <chr>, baker_age <dbl>,
    ## #   baker_occupation <chr>, hometown <chr>
